...
#and other non-PD added into analysis as 'non-PD'
...
#The traiing data is converted one-hot-encoded form, as required by the initiation functions for the machine learning classifiers 
